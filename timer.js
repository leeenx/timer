function Timer () {
  ...
  // 清空所有的 interval
  this.cleanInterval = function (id) {
  ...
  this.pause = function (id) {
    if (id === undefined) {
      ...
      stos.forEach(function (item, itemId) {
        that.pauseTimeout(itemId)
      })
      sivs.forEach(function (item, itemId) {
        that.pauseInterval(itemId)
      })
      return true
  ...
  this.resume = function (id) {
    if (id === undefined) {
      // 表示暂停全部 timeout & interval
      stos.forEach(function (item, itemId) {
        that.resumeTimeout(itemId)
      })
      sivs.forEach(function (item, itemId) {
        that.resumeInterval(itemId)
      })
      return true
    } else if (stos[id] !== undefined) {
